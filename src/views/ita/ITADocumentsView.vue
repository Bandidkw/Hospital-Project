...
// import axios from 'axios'; // ไม่ต้องใช้ axios ชั่วคราว
...
const allITATopics = ref<ITATopic[]>([
  ...
  },
  {
    ...
    documents: [
      {
        id: 201,
        name: 'แผนการจัดซื้อจัดจ้าง ประจำปี 2567',
        path: '/ita/2567/purchase_plan_2567.pdf',
        quarter: 'Q1',
      },
      {
        id: 202,
        name: 'ประกาศผลการจัดซื้อจัดจ้าง ไตรมาสที่ 1',
        path: '/ita/2567/purchase_q1_result.pdf',
        quarter: 'Q1',
      },
      {
        id: 203,
        name: 'ประกาศผลการจัดซื้อจัดจ้าง ไตรมาสที่ 2',
        path: '/ita/2567/purchase_q2_result.pdf',
        quarter: 'Q2',
      },
    ],
  },
  {
    ...
    documents: [
      {
        id: 301,
        name: 'นโยบายการบริหารทรัพยากรบุคคล',
        path: '/ita/2567/hr_policy.pdf',
        quarter: 'Q1',
      },
      {
        id: 302,
        name: 'รายงานผลการประเมินการปฏิบัติงานบุคลากร',
        path: '/ita/2567/hr_report.pdf',
        quarter: 'Q2',
      },
    ],
  },
  {
    ...
    documents: [
      {
        id: 401,
        name: 'แผนการดำเนินงาน ประจำปี 2567',
        path: '/ita/2567/op_plan.pdf',
        quarter: 'Q1',
      },
      {
        id: 402,
        name: 'รายงานการใช้งบประมาณ ไตรมาส 1',
        path: '/ita/2567/budget_q1.pdf',
        quarter: 'Q1',
      },
      {
        id: 403,
        name: 'รายงานการใช้งบประมาณ ไตรมาส 2',
        path: '/ita/2567/budget_q2.pdf',
        quarter: 'Q2',
      },
      {
        id: 404,
        name: 'รายงานการใช้งบประมาณ ไตรมาส 3',
        path: '/ita/2567/budget_q3.pdf',
        quarter: 'Q3',
      },
    ],
  },
  // Data for Year 2566
  {
    ...
    documents: [
      {
        id: 501,
        name: 'เอกสารโครงสร้างองค์กร (2566)',
        path: '/ita/2566/doc_01_2566.pdf',
        quarter: 'Q1',
      },
  ...
  },
  {
    ...
    documents: [
      {
        id: 601,
        name: 'แผนการจัดซื้อจัดจ้าง ประจำปี 2566',
        path: '/ita/2566/purchase_plan_2566.pdf',
        quarter: 'Q1',
      },
      {
        id: 602,
        name: 'ประกาศผลการจัดซื้อจัดจ้าง ไตรมาสที่ 1 (2566)',
        path: '/ita/2566/purchase_q1_result_2566.pdf',
        quarter: 'Q1',
      },
      {
        id: 603,
        name: 'ประกาศผลการจัดซื้อจัดจ้าง ไตรมาสที่ 2 (2566)',
        path: '/ita/2566/purchase_q2_result_2566.pdf',
        quarter: 'Q2',
      },
      {
        id: 604,
        name: 'ประกาศผลการจัดซื้อจัดจ้าง ไตรมาสที่ 3 (2566)',
        path: '/ita/2566/purchase_q3_result_2566.pdf',
        quarter: 'Q3',
      },
    ],
  },
  // Data for Year 2565
  {
    ...
    documents: [
      {
        id: 701,
        name: 'เอกสารโครงสร้างองค์กร (2565)',
        path: '/ita/2565/doc_01_2565.pdf',
        quarter: 'Q1',
      },
  ...
  },
  {
    ...
    documents: [
      {
        id: 801,
        name: 'แผนการจัดซื้อจัดจ้าง ประจำปี 2565',
        path: '/ita/2565/purchase_plan_2565.pdf',
        quarter: 'Q1',
      },
      {
        id: 802,
        name: 'ประกาศผลการจัดซื้อจัดจ้าง ไตรมาสที่ 1 (2565)',
        path: '/ita/2565/purchase_q1_result_2565.pdf',
        quarter: 'Q1',
      },
      {
        id: 803,
        name: 'ประกาศผลการจัดซื้อจัดจ้าง ไตรมาสที่ 2 (2565)',
        path: '/ita/2565/purchase_q2_result_2565.pdf',
        quarter: 'Q2',
      },
      {
        id: 804,
        name: 'ประกาศผลการจัดซื้อจัดจ้าง ไตรมาสที่ 3 (2565)',
        path: '/ita/2565/purchase_q3_result_2565.pdf',
        quarter: 'Q3',
      },
      {
        id: 805,
        name: 'ประกาศผลการจัดซื้อจัดจ้าง ไตรมาสที่ 4 (2565)',
        path: '/ita/2565/purchase_q4_result_2565.pdf',
        quarter: 'Q4',
      },
    ],
  },
...
// const loading = ref(true); // คอมเมนต์หรือลบออก
// const error = ref<string | null>(null); // คอมเมนต์หรือลบออก
